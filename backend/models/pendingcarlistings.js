...
const pendingcarListingSchema = new mongoose.Schema({
  brand: String,
  model: String,
  year: {
    type: Number,
...
const pendingCarListing = mongoose.model('pendingCarListing', pendingcarListingSchema);

module.exports = pendingCarListing;
